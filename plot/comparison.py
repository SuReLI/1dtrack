...
ax1.set_ylabel('Loss')
ax1.legend([l1, l2], ['Vanilla UCT', 'OLUCT'],numpoints=1,loc='lower right')
...
ax2.legend([l1, l2], ['Vanilla UCT', 'OLUCT'],numpoints=1,loc='lower right')

l1 = ax1.errorbar(pl_range, calls1_means, color=BLUE, yerr=calls1_stdev, fmt='o')
l2 = ax1.errorbar(pl_range, calls2_means, color=ORNG, yerr=calls2_stdev, fmt='o')
ax3.set_xlabel('Transition failure probability')
ax3.set_ylabel('Number of calls')
ax3.legend([l1, l2], ['Vanilla UCT', 'OLUCT'],numpoints=1,loc='lower right')
