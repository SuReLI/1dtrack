...
f, (ax1, ax2, ax3, ax4) = plt.subplots(4, 1, sharex=True, figsize=(9.4,12.6))

if discrete:
	root_path = 'data/backup/discrete/short_plc'
else:
	root_path = 'data/backup/continuous/long_plc'
[uct_lo_mea, uct_lo_std, uct_cp_mea, uct_cp_std, uct_ca_mea, uct_ca_std] = extract(root_path + '0',fp_range,take_log)
lw = 2.3
args = [fp_range, fp_range_val, take_log, ax1, ax2, ax3, ax4]
l1 = plot(root_path + '1_b0', args, PL1, 's', PL1,    lw, '-', uct_lo_mea)
if discrete:
	l2 = plot(root_path + '1_b1', args, PL2, '^', PL2,    lw, '-.', uct_lo_mea)
l3 = plot(root_path + '1_b2', args, PL3, 'o', 'none', lw, '-', uct_lo_mea)
l4 = plot(root_path + '1_b3', args, PL4, 's', 'none', lw, '-.', uct_lo_mea)
l5 = plot(root_path + '1_b4', args, PL5, '^', 'none', lw, '--', uct_lo_mea)
l0 = plot(root_path + '0',    args, PL0, 'o', PL0,    lw, '-', uct_lo_mea)
...
ylab2 = 'Mean loss\nrelatively to UCT'
ylab2_log = 'Log of the mean loss\nrelatively to UCT'
